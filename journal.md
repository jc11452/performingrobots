...
We first edited the code to ensure that both the left and right elbow motors were properly coordinated. Although we had already confirmed that both motors were functioning, their shaft positions were different when set to the default state. To fix this, we adjusted the code so that both motors would start in the same downward position.
...
Today we focused on finishing the arms. We continued the cutting work from last week, after resizing the wooden squares, we glued them onto the ends of the arm structure. Then we drilled the arms onto the shoulders using screws so they would be securely fastened with no risk of falling off again. Next, we checked the wiring to ensure all the connections were still intact. During one of the Arduino test actions, the robot’s body twisted at an unnatural angle, which caused some wires to snap off and one of the arms to detach. We discovered that one of the wire connections to the +/– terminals on the Arduino board had come loose. We trimmed the wire end, stripped the rubber coating, and screwed it back into its corresponding channel.

<img height="370" alt="Screenshot 2025-12-12 at 8 46 00 PM" src="https://github.com/user-attachments/assets/eff1a7ea-0d05-4109-91de-7748fcdbba0c" />
<img height="370" alt="Screenshot 2025-12-12 at 8 46 06 PM" src="https://github.com/user-attachments/assets/aee50f54-6214-4f14-95ea-40b53f8bfbe2" />

Even though this process took a considerable amount of time, we decided to continue working, as we felt the earlier mistake had set back our progress. We chose to construct the head and facial features before ending for the night. Using a ruler, we measured how wide the cube would be. Once we had the measurements, Clara cut the cardboard pieces and I glued them together. After assembling the cube, we attached it to the surface of the neck, ensuring we used enough glue to stabilize it. Next, we looked for eyes and lips. With “Baddie” as our keyword, we searched for sharp, anime-style eyes and full, glossy lips. Clara printed several sizes so that we could choose and cut the most suitable ones.
...
<img width="500" alt="Screenshot 2025-12-12 at 4 24 29 PM" src="https://github.com/user-attachments/assets/dd16d9ed-a64e-4d05-83da-5eab8026f7ee" />
...
<img height="370" alt="Screenshot 2025-12-12 at 4 24 15 PM" src="https://github.com/user-attachments/assets/7bc8845d-a7f1-4780-8944-d784b5ab11d5" />
